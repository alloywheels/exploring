...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Elements\1.4.2\Enums.uno
// ------------------------------------------------------------------------------------------
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Elements\1.4.2\Element.Transform.uno
// ------------------------------------------------------------------------------------------------------
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Elements\1.4.2\AspectBoxSizing.uno
// ----------------------------------------------------------------------------------------------------
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Elements\1.4.2\BoxSizing.uno
// ----------------------------------------------------------------------------------------------
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Elements\1.4.2\Element.Layout.uno
// ---------------------------------------------------------------------------------------------------
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Elements\1.4.2\Caching\Cache.Heuristic.uno
// ------------------------------------------------------------------------------------------------------------
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Elements\1.4.2\Caching\Cache.uno
// --------------------------------------------------------------------------------------------------
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Elements\1.4.2\Caching\ElementAtlasPool.uno
// -------------------------------------------------------------------------------------------------------------
...
void Element__Draw_fn(Element* __this, ::g::Fuse::DrawContext* dc)
{
    if (!__this->IsRootingCompleted())
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Draw called on a non-rooted node"), __this, uString::Const("C:\\Users\\krys.kolodziejczyk\\AppData\\Local\\Fusetools\\Packages\\Fuse.Elements\\1.4.2\\Element.Drawing.uno"), 67, uString::Const("Draw"));
...
void Element__OnArrangeMarginBox_fn(Element* __this, ::g::Uno::Float2* position, ::g::Fuse::LayoutParams* lp, ::g::Uno::Float2* __retval)
{
    ...
    if (bp.SanityConstrain())
    {
        if (!Element::_invalidValuesWarn_)
            ::g::Fuse::Diagnostics::InternalError(uString::Const("Invalid values in ArrangeMarginBox"), __this, uString::Const("C:\\Users\\krys.kolodziejczyk\\AppData\\Local\\Fusetools\\Packages\\Fuse.Elements\\1.4.2\\Element.Layout.uno"), 262, uString::Const("OnArrangeMarginBox"));
...
::g::Uno::Graphics::Framebuffer* Element::CaptureRegion(::g::Fuse::DrawContext* dc, ::g::Uno::Rect region, ::g::Uno::Float2 padding)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(uString::Const("CaptureRegion bigger than maximum texture size, dropping rendering (size: "), uBox(::g::Uno::Int2_typeof(), fsz)), uString::Const(", max-size: ")), uBox<int>(::g::Uno::Int_typeof(), ::g::Uno::Graphics::Texture2D::MaxSize())), 0, uString::Const("../../../AppData/Local/Fusetools/Packages/Fuse.Elements/1.4.2/Element.Drawing.uno"), 40);
        return NULL;
    }
...
void Element::Composit(::g::Fuse::DrawContext* dc)
{
    ...
    if (!r && !_warnNoCacheDraw)
    {
        ...
        ::g::Fuse::Diagnostics::InternalError(uString::Const("This element can not be drawn."), this, uString::Const("C:\\Users\\krys.kolodziejczyk\\AppData\\Local\\Fusetools\\Packages\\Fuse.Elements\\1.4.2\\Element.Effects.uno"), 125, uString::Const("Composit"));
    }
}
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Elements\1.4.2\Caching\ElementAtlas.uno
// ---------------------------------------------------------------------------------------------------------
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Elements\1.4.2\Caching\ElementBatch.uno
// ---------------------------------------------------------------------------------------------------------
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Elements\1.4.2\Caching\ElementBatcher.uno
// -----------------------------------------------------------------------------------------------------------
...
static void ElementBatcher_build(uType* type)
{
    ...
    ::STRINGS[11] = uString::Const("../../../AppData/Local/Fusetools/Packages/Fuse.Elements/1.4.2/Caching/ElementBatcher.uno");
    ...
    {
        {
            while (enum4.MoveNext(::TYPES[18/*Uno.Collections.List<Fuse.Visual>.Enumerator*/]))
            {
                ...
                if (emitNewBatch || (atlas == NULL))
                {
                    ...
                    {
                        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[10/*"BUG: atlas-...*/], 0, ::STRINGS[11/*"../../../Ap...*/], 253);
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Elements\1.4.2\LayoutFunctions.uno
// ----------------------------------------------------------------------------------------------------
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Elements\1.4.2\Element.HitTest.uno
// ----------------------------------------------------------------------------------------------------
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Elements\1.4.2\InteractiveTransform.uno
// ---------------------------------------------------------------------------------------------------------
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Elements\1.4.2\Element.ITreeRenderer.uno
// ----------------------------------------------------------------------------------------------------------
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Elements\1.4.2\LayoutMasterBoxSizing.uno
// ----------------------------------------------------------------------------------------------------------
...
static void LayoutFunction__LayoutSubscription_build(uType* type)
{
    ...
    type->SetFields(5,
        ...
        ::TYPES[19/*Fuse.Elements.Element*/], offsetof(LayoutFunction__LayoutSubscription, _element), 0);
}
...
void LayoutFunction__LayoutSubscription__Dispose_fn(LayoutFunction__LayoutSubscription* __this)
{
    ...
    if (__this->_element != NULL)
        uPtr(__this->_element)->remove_Placed(uDelegate::New(::TYPES[24/*Fuse.PlacedHandler*/], (void*)LayoutFunction__LayoutSubscription__OnPlaced_fn, __this));
}
...
void LayoutFunction__LayoutSubscription__OnNewOperand_fn(LayoutFunction__LayoutSubscription* __this, uObject* elmObj)
{
    ...
    if (__this->_element != NULL)
    {
        uPtr(__this->_element)->add_Placed(uDelegate::New(::TYPES[24/*Fuse.PlacedHandler*/], (void*)LayoutFunction__LayoutSubscription__OnPlaced_fn, __this));
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Elements\1.4.2\LimitBoxSizing.uno
// ---------------------------------------------------------------------------------------------------
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Elements\1.4.2\Transforms.uno
// -----------------------------------------------------------------------------------------------
