...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Elements\1.4.2\Triggers\Actions\BringIntoView.uno
// -------------------------------------------------------------------------------------------------------------------
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Controls\1.4.2\Triggers\BringToFront.uno
// ----------------------------------------------------------------------------------------------------------
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.2\Actions\Callback.uno
// -----------------------------------------------------------------------------------------------------
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.2\Actions\CancelInteractions.uno
// ---------------------------------------------------------------------------------------------------------------
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.2\Actions\Visibility.uno
// -------------------------------------------------------------------------------------------------------
...
static void Collapse_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\Users\\krys.kolodziejczyk\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\1.4.2\\Actions\\Visibility.uno");
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.2\Actions\DebugAction.uno
// --------------------------------------------------------------------------------------------------------
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.2\Actions\DebugProperty.uno
// ----------------------------------------------------------------------------------------------------------
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Controls.WebView\1.4.2\EvaluateJS.uno
// -------------------------------------------------------------------------------------------------------
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.2\Actions\Focus.uno
// --------------------------------------------------------------------------------------------------
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.2\Actions\Toggle.uno
// ---------------------------------------------------------------------------------------------------
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Controls.WebView\1.4.2\WebViewNavActions.uno
// --------------------------------------------------------------------------------------------------------------
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.2\Actions\Playback.uno
// -----------------------------------------------------------------------------------------------------
...
{
    ::TYPES[14] = ::g::Fuse::Node_typeof()->MakeMethod(1/*FindByType<Fuse.Triggers.IPlayback>*/, ::g::Fuse::Triggers::IPlayback_typeof(), NULL);
...
void Pause__Perform_fn(Pause* __this, ::g::Fuse::Node* target)
{
    uObject* ind1;
    ind1 = __this->Target();
    uObject* t = (ind1 != NULL) ? ind1 : (uObject*)uPtr(target)->FindByType(::TYPES[14/*Fuse.Node.FindByType<Fuse.Triggers.IPlayback>*/]);
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.2\Actions\Pulse.uno
// --------------------------------------------------------------------------------------------------
...
{
    ::TYPES[16] = ::g::Fuse::Triggers::IPulseTrigger_typeof();
    type->SetFields(8,
        ::TYPES[16/*Fuse.Triggers.IPulseTrigger*/], offsetof(Pulse, _Target), 0);
}
...
void Pulse__Perform_fn(Pulse* __this, ::g::Fuse::Node* target)
{
    ...
    if (t != NULL)
        ::g::Fuse::Triggers::IPulseTrigger::Pulse(uInterface(uPtr(t), ::TYPES[16/*Fuse.Triggers.IPulseTrigger*/]));
}
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.UserEvents\1.4.2\RaiseUserEvent.uno
// -----------------------------------------------------------------------------------------------------
...
static void RaiseUserEvent_build(uType* type)
{
    ...
    ::STRINGS[7] = uString::Const("C:\\Users\\krys.kolodziejczyk\\AppData\\Local\\Fusetools\\Packages\\Fuse.UserEvents\\1.4.2\\RaiseUserEvent.uno");
    ::STRINGS[2] = uString::Const("Perform");
    ::TYPES[17] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Triggers::Actions::UserEventArg_typeof(), NULL);
    ::TYPES[18] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[19] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Triggers::Actions::UserEventArg_typeof(), NULL);
    ::TYPES[20] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[21] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Triggers::Actions::UserEventArg_typeof(), NULL);
...
void RaiseUserEvent__Perform_fn(RaiseUserEvent* __this, ::g::Fuse::Node* target)
{
    ...
    if (__this->_event == NULL)
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[6/*"no UserEven...*/], ::g::Uno::UX::Selector__op_Implicit1(__this->EventName())), __this, ::STRINGS[7/*"C:\\Users\\...*/], 86, ::STRINGS[2/*"Perform"*/], NULL);
    else
...
::g::Uno::Collections::Dictionary* RaiseUserEvent::ConvertArgs()
{
    ...
    if ((_args == NULL) || (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(_args), ::TYPES[17/*Uno.Collections.ICollection<Fuse.Triggers.Actions.UserEventArg>*/])) == 0))
        return NULL;

    ::g::Uno::Collections::Dictionary* d = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[18/*Uno.Collections.Dictionary<string, object>*/]);
    uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(_args), ::TYPES[19/*Uno.Collections.IEnumerable<Fuse.Triggers.Actions.UserEventArg>*/]));

    try
    {
        {
            while (::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[20/*Uno.Collections.IEnumerator*/])))
            {
                ::g::Fuse::Triggers::Actions::UserEventArg* arg = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[21/*Uno.Collections.IEnumerator<Fuse.Triggers.Actions.UserEventArg>*/]), &ret3), ret3);
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Controls.Navigation\1.4.2\NavigationActions.uno
// -----------------------------------------------------------------------------------------------------------------
...
static void ReleasePage_build(uType* type)
{
    ...
    ::STRINGS[9] = uString::Const("C:\\Users\\krys.kolodziejczyk\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Navigation\\1.4.2\\NavigationActions.uno");
    ::STRINGS[2] = uString::Const("Perform");
    ::TYPES[1] = ::g::Fuse::Node_typeof()->MakeMethod(1/*FindByType<Fuse.Visual>*/, ::g::Fuse::Visual_typeof(), NULL);
    ::TYPES[23] = ::g::Fuse::Controls::Navigator_typeof();
    ::TYPES[24] = ::g::Uno::Action_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetFields(8,
        ::g::Fuse::Visual_typeof(), offsetof(ReleasePage, _pendVisual), 0,
        ::TYPES[23/*Fuse.Controls.Navigator*/], offsetof(ReleasePage, _pendNavigator), 0);
}
...
void ReleasePage__Perform_fn(ReleasePage* __this, ::g::Fuse::Node* n)
{
    ...
    __this->_pendNavigator = ((__this->_pendVisual == NULL) ? uCast< ::g::Fuse::Controls::Navigator*>(NULL, ::TYPES[23/*Fuse.Controls.Navigator*/]) : uAs< ::g::Fuse::Controls::Navigator*>(uPtr(__this->_pendVisual)->Parent(), ::TYPES[23/*Fuse.Controls.Navigator*/]));

    if ((__this->_pendVisual == NULL) || (__this->_pendNavigator == NULL))
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[8/*"Requires a ...*/], __this, ::STRINGS[9/*"C:\\Users\\...*/], 26, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }

    ::g::Fuse::UpdateManager::AddDeferredAction2(uDelegate::New(::TYPES[24/*Uno.Action*/], (void*)ReleasePage__DeferredRelease_fn, __this), -1, 2);
}
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.2\Actions\Set.uno
// ------------------------------------------------------------------------------------------------
...
{
    ::STRINGS[10] = uString::Const("Cannot find an Element/IShow");
    ::STRINGS[1] = uString::Const("C:\\Users\\krys.kolodziejczyk\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\1.4.2\\Actions\\Visibility.uno");
    ::STRINGS[2] = uString::Const("Perform");
    ::TYPES[25] = ::g::Fuse::Node_typeof()->MakeMethod(1/*FindByType<Fuse.Triggers.Actions.IShow>*/, ::g::Fuse::Triggers::Actions::IShow_typeof(), NULL);
    ::TYPES[26] = ::g::Fuse::Triggers::Actions::IShow_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetFields(8);
}
...
{
    uObject* t = (uObject*)uPtr(target)->FindByType(::TYPES[25/*Fuse.Node.FindByType<Fuse.Triggers.Actions.IShow>*/]);

    if (t != NULL)
        ::g::Fuse::Triggers::Actions::IShow::Show(uInterface(uPtr(t), ::TYPES[26/*Fuse.Triggers.Actions.IShow*/]));
    else
        ::g::Fuse::Diagnostics::UserError(::STRINGS[10/*"Cannot find...*/], __this, ::STRINGS[1/*"C:\\Users\\...*/], 38, ::STRINGS[2/*"Perform"*/], NULL);
}
// }
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.2\Actions\TimelineAction.uno
// -----------------------------------------------------------------------------------------------------------
...
{
    ::STRINGS[11] = uString::Const("`TimelineAction` called without a `Timeline` `Target`");
    ::STRINGS[12] = uString::Const("C:\\Users\\krys.kolodziejczyk\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\1.4.2\\Actions\\TimelineAction.uno");
    ::STRINGS[2] = uString::Const("Perform");
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetFields(8,
...
void TimelineAction__Perform_fn(TimelineAction* __this, ::g::Fuse::Node* target)
{
    ...
    if (t == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[11/*"`TimelineAc...*/], __this, ::STRINGS[12/*"C:\\Users\\...*/], 48, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
...
{
    ::STRINGS[13] = uString::Const("Could not find `IToggleable` target");
    ::STRINGS[14] = uString::Const("C:\\Users\\krys.kolodziejczyk\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\1.4.2\\Actions\\Toggle.uno");
    ::STRINGS[2] = uString::Const("Perform");
    ::TYPES[27] = ::g::Fuse::Node_typeof()->MakeMethod(1/*FindByType<Fuse.Triggers.Actions.IToggleable>*/, ::g::Fuse::Triggers::Actions::IToggleable_typeof(), NULL);
    ::TYPES[28] = ::g::Fuse::Triggers::Actions::IToggleable_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetFields(8,
        ::TYPES[28/*Fuse.Triggers.Actions.IToggleable*/], offsetof(Toggle, _Target), 0);
}
...
void Toggle__Perform_fn(Toggle* __this, ::g::Fuse::Node* target)
{
    uObject* ind1;
    ind1 = __this->Target();
    uObject* t = (ind1 != NULL) ? ind1 : (uObject*)uPtr(target)->FindByType(::TYPES[27/*Fuse.Node.FindByType<Fuse.Triggers.Actions.IToggleable>*/]);

    if (t == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[13/*"Could not f...*/], __this, ::STRINGS[14/*"C:\\Users\\...*/], 41, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }

    ::g::Fuse::Triggers::Actions::IToggleable::Toggle(uInterface(uPtr(t), ::TYPES[28/*Fuse.Triggers.Actions.IToggleable*/]));
}
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Elements\1.4.2\Triggers\LayoutAnimation.uno
// -------------------------------------------------------------------------------------------------------------
...
{
    ::STRINGS[15] = uString::Const("Missing `From` or cannot find `Element` target");
    ::STRINGS[16] = uString::Const("C:\\Users\\krys.kolodziejczyk\\AppData\\Local\\Fusetools\\Packages\\Fuse.Elements\\1.4.2\\Triggers\\LayoutAnimation.uno");
    ::STRINGS[2] = uString::Const("Perform");
    ::TYPES[0] = ::g::Fuse::Elements::Element_typeof();
    ::TYPES[1] = ::g::Fuse::Node_typeof()->MakeMethod(1/*FindByType<Fuse.Visual>*/, ::g::Fuse::Visual_typeof(), NULL);
    ::TYPES[24] = ::g::Uno::Action_typeof();
...
void TransitionLayout__Perform_fn(TransitionLayout* __this, ::g::Fuse::Node* target)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[15/*"Missing `Fr...*/], __this, ::STRINGS[16/*"C:\\Users\\...*/], 355, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }

    ::g::Fuse::UpdateManager::AddDeferredAction2(uDelegate::New(::TYPES[24/*Uno.Action*/], (void*)TransitionLayout__Transition_fn, __this), 1, 3);
}
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.2\Actions\StateTransition.uno
// ------------------------------------------------------------------------------------------------------------
...
{
    ::STRINGS[17] = uString::Const("Missing `Target`");
    ::STRINGS[18] = uString::Const("C:\\Users\\krys.kolodziejczyk\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\1.4.2\\Actions\\StateTransition.uno");
    ::STRINGS[2] = uString::Const("Perform");
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetFields(8,
...
void TransitionState__Perform_fn(TransitionState* __this, ::g::Fuse::Node* target)
{
    ...
    if (t == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[17/*"Missing `Ta...*/], __this, ::STRINGS[18/*"C:\\Users\\...*/], 24, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.2\Actions\TriggerAction.uno
// ----------------------------------------------------------------------------------------------------------
...
{
    ::TYPES[29] = ::g::Fuse::Node_typeof()->MakeMethod(1/*FindByType<Fuse.Controls.WebView>*/, ::g::Fuse::Controls::WebView_typeof(), NULL);
    type->SetFields(8);
}
...
{
    ::g::Fuse::Controls::WebView* webView = (::g::Fuse::Controls::WebView*)uPtr(target)->FindByType(::TYPES[29/*Fuse.Node.FindByType<Fuse.Controls.WebView>*/]);
