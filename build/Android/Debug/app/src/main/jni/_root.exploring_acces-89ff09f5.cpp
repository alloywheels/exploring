...
// {
// static generated exploring_accessor_ExploreItem_ImageName() :11
...
static void exploring_accessor_ExploreItem_ImageName_build(uType* type)
{
    ...
    type->SetFields(0,
        ::g::Uno::UX::PropertyAccessor_typeof(), (uintptr_t)&exploring_accessor_ExploreItem_ImageName::Singleton_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&exploring_accessor_ExploreItem_ImageName::_name_, uFieldFlagsStatic);
}
...
{
    return *__retval = exploring_accessor_ExploreItem_ImageName::_name_, void();
}
