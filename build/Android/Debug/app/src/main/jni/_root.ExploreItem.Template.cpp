...
static void ExploreItem__Template_build(uType* type)
{
    ...
    type->SetFields(2,
        ::g::ExploreItem_typeof(), offsetof(ExploreItem__Template, __parent1), uFieldFlagsWeak,
        ::g::ExploreItem_typeof(), offsetof(ExploreItem__Template, __parentInstance1), uFieldFlagsWeak,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(ExploreItem__Template, temp_Value_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(ExploreItem__Template, temp1_Value_inst), 0,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&ExploreItem__Template::__selector0_, uFieldFlagsStatic);
}
...
void ExploreItem__Template__New1_fn(ExploreItem__Template* __this, uObject** __retval)
{
    ...
    __this->temp_Value_inst = ::g::exploring_FuseControlsTextControl_Value_Property::New1(temp, ExploreItem__Template::__selector0_);
    ::g::Fuse::Reactive::Data* temp2 = ::g::Fuse::Reactive::Data::New1(::STRINGS[1/*"title"*/]);
    ::g::Fuse::Controls::Text* temp1 = ::g::Fuse::Controls::Text::New3();
    __this->temp1_Value_inst = ::g::exploring_FuseControlsTextControl_Value_Property::New1(temp1, ExploreItem__Template::__selector0_);
    ...
    ::g::Fuse::Reactive::DataBinding* temp5 = ::g::Fuse::Reactive::DataBinding::New1(__this->temp1_Value_inst, (uObject*)temp3, 3);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp1->Bindings()), ::TYPES[0/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp5);
