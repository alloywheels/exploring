...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.4.2\Layouts\CircleLayout.uno
// ----------------------------------------------------------------------------------------------------------------
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.4.2\Layouts\GridLayout.uno
// --------------------------------------------------------------------------------------------------------------
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.4.2\Layouts\ColumnLayout.uno
// ----------------------------------------------------------------------------------------------------------------
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.4.2\Layouts\DefaultLayout.uno
// -----------------------------------------------------------------------------------------------------------------
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.4.2\Layouts\DockLayout.uno
// --------------------------------------------------------------------------------------------------------------
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.4.2\Layouts\WrapLayout.uno
// --------------------------------------------------------------------------------------------------------------
...
static void GridLayout_build(uType* type)
{
    ...
    ::TYPES[0] = ::g::Fuse::Visual_typeof()->MakeMethod(2/*FirstChild<Fuse.Visual>*/, ::g::Fuse::Visual_typeof(), NULL);
    ::TYPES[1] = ::g::Fuse::Node_typeof()->MakeMethod(3/*NextSibling<Fuse.Visual>*/, ::g::Fuse::Visual_typeof(), NULL);
    ::TYPES[9] = type->MakeMethod(5/*UserCount<Fuse.Layouts.Column>*/, ::g::Fuse::Layouts::Column_typeof(), NULL);
    ::TYPES[10] = type->MakeMethod(5/*UserCount<Fuse.Layouts.Row>*/, ::g::Fuse::Layouts::Row_typeof(), NULL);
    ::TYPES[11] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Int_typeof(), NULL);
    ::TYPES[12] = type->MakeMethod(4/*TrimPad<Fuse.Layouts.Row>*/, ::g::Fuse::Layouts::Row_typeof(), NULL);
    ::TYPES[13] = type->MakeMethod(4/*TrimPad<Fuse.Layouts.Column>*/, ::g::Fuse::Layouts::Column_typeof(), NULL);
    ...
    ::TYPES[27] = ::TYPES[26/*Fuse.Layouts.DefinitionBase*/]->MakeMethod(3/*Serialize<Fuse.Layouts.Column>*/, ::g::Fuse::Layouts::Column_typeof(), NULL);
    ::TYPES[28] = ::TYPES[26/*Fuse.Layouts.DefinitionBase*/]->MakeMethod(2/*Parse<Fuse.Layouts.Column>*/, ::g::Fuse::Layouts::Column_typeof(), NULL);
    ::TYPES[29] = ::TYPES[26/*Fuse.Layouts.DefinitionBase*/]->MakeMethod(3/*Serialize<Fuse.Layouts.Row>*/, ::g::Fuse::Layouts::Row_typeof(), NULL);
    ::TYPES[30] = ::TYPES[26/*Fuse.Layouts.DefinitionBase*/]->MakeMethod(2/*Parse<Fuse.Layouts.Row>*/, ::g::Fuse::Layouts::Row_typeof(), NULL);
    ...
    type->MethodTypes[4]->SetPrecalc(
        ...
        ::TYPES[26/*Fuse.Layouts.DefinitionBase*/]->MakeMethod(0/*Copy<T>*/, type->MethodTypes[4]->U(0), NULL),
...
{
    return ::g::Fuse::Layouts::DefinitionBase::Serialize1(::TYPES[27/*Fuse.Layouts.DefinitionBase.Serialize<Fuse.Layouts.Column>*/], ColumnList());
}

// public void set_Columns(string value) [instance] :379
void GridLayout::Columns(uString* value)
{
    ::g::Fuse::Layouts::DefinitionBase::Parse1(::TYPES[28/*Fuse.Layouts.DefinitionBase.Parse<Fuse.Layouts.Column>*/], value, ColumnList());
    Changed();
}
...
{
    return ::g::Fuse::Layouts::DefinitionBase::Serialize1(::TYPES[29/*Fuse.Layouts.DefinitionBase.Serialize<Fuse.Layouts.Row>*/], RowList());
}

// public void set_Rows(string value) [instance] :277
void GridLayout::Rows(uString* value)
{
    ::g::Fuse::Layouts::DefinitionBase::Parse1(::TYPES[30/*Fuse.Layouts.DefinitionBase.Parse<Fuse.Layouts.Row>*/], value, RowList());
    Changed();
}
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.4.2\Layouts\Layout.uno
// ----------------------------------------------------------------------------------------------------------
...
// C:\Users\krys.kolodziejczyk\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.4.2\Layouts\StackLayout.uno
// ---------------------------------------------------------------------------------------------------------------
...
static void WrapLayout_build(uType* type)
{
    ...
    ::TYPES[2] = ::g::Uno::Float_typeof()->Array();
    ::TYPES[34] = ::g::Uno::Int_typeof()->Array();
    ::TYPES[3] = ::g::Fuse::Visual_typeof()->MakeMethod(2/*FirstChild<Fuse.Node>*/, ::g::Fuse::Node_typeof(), NULL);
    ::TYPES[5] = ::g::Fuse::Node_typeof()->MakeMethod(3/*NextSibling<Fuse.Node>*/, ::g::Fuse::Node_typeof(), NULL);
    ::TYPES[4] = ::g::Fuse::Visual_typeof();
    type->SetFields(2,
...
::g::Uno::Float2 WrapLayout::Arrange(::g::Fuse::Visual* container, ::g::Fuse::LayoutParams lp, bool doArrange, ::g::Uno::Float4 padding)
{
    ...
    uArray* placements = uArray::New(::TYPES[32/*float4[]*/], ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr(container)->Children()), ::TYPES[33/*Uno.Collections.ICollection<Fuse.Node>*/])));
    uArray* minorSizes = uArray::New(::TYPES[2/*float[]*/], ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(container->Children()), ::TYPES[33/*Uno.Collections.ICollection<Fuse.Node>*/])));
    uArray* elementOnRow = uArray::New(::TYPES[34/*int[]*/], ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(container->Children()), ::TYPES[33/*Uno.Collections.ICollection<Fuse.Node>*/])));
    uArray* majorRest = uArray::New(::TYPES[2/*float[]*/], ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(container->Children()), ::TYPES[33/*Uno.Collections.ICollection<Fuse.Node>*/])));
    int majorStart = 0;
    int currentRow = 0;
    int i = 0;
    ...
    for (int j1 = majorStart; j1 < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(container->Children()), ::TYPES[33/*Uno.Collections.ICollection<Fuse.Node>*/])); ++j1)
