...
// public partial sealed class ExploreItem.Template2 :153
// {
// static Template2() :164
...
static void ExploreItem__Template2_build(uType* type)
{
    ...
    type->SetFields(2,
        ::g::ExploreItem_typeof(), offsetof(ExploreItem__Template2, __parent1), uFieldFlagsWeak,
        ::g::ExploreItem_typeof(), offsetof(ExploreItem__Template2, __parentInstance1), uFieldFlagsWeak,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::Float4_typeof(), NULL), offsetof(ExploreItem__Template2, TheColor_Color_inst), 0,
        ::g::Fuse::Drawing::SolidColor_typeof(), offsetof(ExploreItem__Template2, TheColor), 0,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&ExploreItem__Template2::__selector0_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&ExploreItem__Template2::__selector1_, uFieldFlagsStatic);
}
...
// public Template2(ExploreItem parent, ExploreItem parentInstance) :157
...
// public override sealed object New() :167
void ExploreItem__Template2__New1_fn(ExploreItem__Template2* __this, uObject** __retval)
{
    ...
    __this->TheColor = ::g::Fuse::Drawing::SolidColor::New2();
    __this->TheColor_Color_inst = ::g::exploring_FuseDrawingSolidColor_Color_Property::New1(__this->TheColor, ExploreItem__Template2::__selector0_);
    ...
    __self1->Name(ExploreItem__Template2::__selector1_);
    uPtr(__this->TheColor)->Color(::g::Uno::Float4__New2(1.0f, 1.0f, 1.0f, 0.3f));
    ...
    temp3->Factor(1.2f);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(__self1->Fills()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Drawing.Brush>*/]), __this->TheColor);
...
// public Template2 New(ExploreItem parent, ExploreItem parentInstance) :157
...
// public Template2(ExploreItem parent, ExploreItem parentInstance) [instance] :157
...
// public Template2 New(ExploreItem parent, ExploreItem parentInstance) [static] :157
