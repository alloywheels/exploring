...
module.exports = Observable(
	{
		...
		country: '',
		color: '#4F99EE',
		image: "Assets/BOLA-B1-MAIN.png",
		numbers: [
			{ title: 'Modern Look', fact: '' },
			{ title: 'Most PCD`s', fact: '' }
		],
		facts: [
			"Assets/BOLA_B1_CANDYRED_1985_ANGLE.png",
			"Assets/BOLA_B1_GB_1910_ANGLE.png",
			"Assets/BOLA_B1_GD_1895 _ANGLE.png",
			"Assets/BOLA_B1_GM_1910_ANGLE.png",
			"Assets/BOLA_B1_HB_1885 _ANGLE.png",
			"Assets/BOLA_B1_MBRONZE_1985_ANGLE.png",
			"Assets/BOLA_B1_SIL_1895 _ANGLE.png",
			"Assets/BOLA_B1_WHITE_1895 _ANGLE.png"
		]
	},{
		id:1,
		name: 'Iceland',
